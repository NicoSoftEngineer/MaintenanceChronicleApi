...
/// </summary>
public class GetMaintenanceRecordByIdQueryHandler(AppDbContext dbContext)
    : IRequestHandler<GetEntityByIdQuery<MaintenanceRecordDetailDto>, MaintenanceRecordDetailDto>
{
    ...
    {
        MaintenanceRecord? entity = await dbContext.MaintenanceRecords.FindAsync([request.Id], cancellationToken);
        if (entity == null)
        {
